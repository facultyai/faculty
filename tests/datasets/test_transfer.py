...
def test_download(mocker, requests_mock):
    ...
    assert (
        transfer.download(object_client, PROJECT_ID, TEST_PATH) == TEST_CONTENT
    )
...
def test_download_stream(mocker, requests_mock):
    ...
    stream = transfer.download_stream(object_client, PROJECT_ID, TEST_PATH)
...
def test_download_file(mocker, requests_mock, tmpdir):
    ...
    transfer.download_file(object_client, PROJECT_ID, TEST_PATH, destination)
